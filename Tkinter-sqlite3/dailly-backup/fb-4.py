...
# -----------------------------------------------------------------------------------------------------------------------
    # domain button & function
    request_btn = Button(dashboard_frame, text='Request Headers', bg='white', fg='black', width=15, height=1) #
    request_btn.config(font=('verdana', 15))
    request_btn.pack(pady=(10, 20))

    # domain button & function
    response_btn = Button(dashboard_frame, text='Response Headers', bg='white', fg='black', width=15, height=1) #
    response_btn.config(font=('verdana', 15))
    response_btn.pack(pady=(10, 20))

    # domain button & function
    url_btn = Button(dashboard_frame, text='Response URLs', bg='white', fg='black', width=15, height=1) #
