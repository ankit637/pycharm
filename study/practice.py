...
def create_login_window(root_ref):
    ...
    def create_account():
        ...
        create_btn = Button(create_account_window, text='Create Account', bg='white', fg='black', width=15, height=1,
                            command=add_user)
    ...
    # ---------------------------------------------------------------------
    # add text
    text_label = Label(root, text='RequestSuit', fg='white',
                       bg='#0096DC')  # text = text name + fg='' = text colour + bg='' = backgound
    ...
    create_account_btn = Button(root, text='Create Account', bg='white', fg='black', width=15, height=1,
...
def main_dashboard(root_ref):
    ...
    # domain button & function
    subdomain_button = Button(dashboard_frame, text='SubSuit', bg='white', fg='black', width=15, height=1) #
